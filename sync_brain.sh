...
rsync 'ssh -i /sdcard/brain/keys/hetzner1' --status=progress2 --archive --update --prune-empty-dirs --include='*.org' --include='*.pdf'  --exclude='*' mahmooz@mahmooz:/home/mahmooz/brain /sdcard
